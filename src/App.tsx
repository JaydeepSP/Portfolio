...
function App() {
  ...
  return (
    <Layout>
      ...
      <footer className="py-8 text-center text-sm text-text-secondary border-t border-gray-100/50 mt-12">
        <p>&copy; {new Date().getFullYear()} Jaydeep Prajapati. All rights reserved.</p>
      </footer>
    </Layout>
  )
}
